...
const Signup = () => {
  ...
  const handleSignup = () => {
    ...
    if (!mobileOrEmail) {
      validationErrors.mobileOrEmail =
    ...
    if (!fullName) {
      ...
      validationErrors.fullName =
        "Invalid full name. Only alphabets and spaces are allowed.";
    }
    ...
    if (!username) {
      ...
      validationErrors.username =
        "Invalid username. Username must contain 3-30 alphanumeric characters.";
    }
        ...
        <div className="form_signup">
          ...
          <div className="second_div">
            ...
            {errors.mobileOrEmail && (
              <div className="error_message">{errors.mobileOrEmail}</div>
            )}
            ...
            {password && (
              <ul className="password-conditions">
                <li
                  className={
                    password.match(/.*[a-z].*/) ? "checked" : "unchecked"
                  }
                >
                ...
                <li
                  className={password.match(/.*\d.*/) ? "checked" : "unchecked"}
                >
      ...
      {showPopup && (
        <div className="popup">
          <div className="popup-contentsign">
            ...
            <p>
              Thank you for signing up. Enjoy your experience on our platform.
            </p>
